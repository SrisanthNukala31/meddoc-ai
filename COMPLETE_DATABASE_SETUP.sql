...
CREATE INDEX idx_analysis_history_created_at ON public.analysis_history(created_at);
...
-- Execute these as an admin:
-- GRANT USAGE ON SCHEMA public TO authenticated;
-- GRANT ALL ON user_profiles TO authenticated;
-- GRANT ALL ON user_medicines TO authenticated;
-- GRANT ALL ON health_logs TO authenticated;
...
-- GRANT ALL ON lifestyle_profiles TO authenticated;
...
-- END OF SETUP
-- =====================================================================
-- All tables created with proper RLS policies and indexes
-- Remember to test RLS policies in separate authenticated sessions
